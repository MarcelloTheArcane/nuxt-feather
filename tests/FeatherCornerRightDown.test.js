...
import FeatherCornerRightDown from '../icons/FeatherCornerRightDown.vue'

describe('FeatherCornerRightDown component', () => {
  const vm = new Vue(FeatherCornerRightDown).$mount()
