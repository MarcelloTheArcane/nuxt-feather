...
import FeatherBatteryCharging from '../icons/FeatherBatteryCharging.vue'

describe('FeatherBatteryCharging component', () => {
  const vm = new Vue(FeatherBatteryCharging).$mount()
