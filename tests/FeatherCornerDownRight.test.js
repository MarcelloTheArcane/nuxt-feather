...
import FeatherCornerDownRight from '../icons/FeatherCornerDownRight.vue'

describe('FeatherCornerDownRight component', () => {
  const vm = new Vue(FeatherCornerDownRight).$mount()
