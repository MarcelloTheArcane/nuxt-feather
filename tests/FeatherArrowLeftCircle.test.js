...
import FeatherArrowLeftCircle from '../icons/FeatherArrowLeftCircle.vue'

describe('FeatherArrowLeftCircle component', () => {
  const vm = new Vue(FeatherArrowLeftCircle).$mount()
