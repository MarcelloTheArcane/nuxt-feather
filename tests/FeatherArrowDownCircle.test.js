...
import FeatherArrowDownCircle from '../icons/FeatherArrowDownCircle.vue'

describe('FeatherArrowDownCircle component', () => {
  const vm = new Vue(FeatherArrowDownCircle).$mount()
