...
import FeatherArrowRightCircle from '../icons/FeatherArrowRightCircle.vue'

describe('FeatherArrowRightCircle component', () => {
  const vm = new Vue(FeatherArrowRightCircle).$mount()
